...
- **Design First, Code Later:** 기획 변경 시 즉흥적인 코딩을 지양하고, 피그마(UI)와 API 명세서(Data) 문서를 먼저 업데이트 후 코딩 진행.
...
- **Strict Protocol Compliance:** "어떻게 만들었느냐"는 각자의 자율에 맡기되, "무엇을 전달하느냐"는 합의된 API 명세서와 코드 컨벤션을 엄격히 준수한다.
