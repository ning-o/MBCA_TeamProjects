...
티끌 앱 홈 > 냉장고 도메인 홈 > 냉장고 설정 > 영수증 촬영 > OCR 텍스트 추출 및 정제
저장 후 데이터가 반영된 냉장고 홈 > 냉장고 속 재료(유통기한 자동 기입) > 냉장고 털기(냉장고 속 재료 기반 레시피 추천) > 날짜 기반 LLM 제철 음식 기반 레시피 추천
